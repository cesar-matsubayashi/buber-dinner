...
namespace BuberDinner.Infrastructure.Migrations
{
    ...
    [Migration("20250521185526_MenuReviewRemoveCompositeKey")]
    partial class MenuReviewRemoveCompositeKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuberDinner.Domain.Bill.Bill", b =>
                {
                    b.HasOne("BuberDinner.Domain.Dinner.Dinner", null)
                        .WithMany()
                        .HasForeignKey("DinnerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BuberDinner.Domain.Guest.Guest", null)
                        .WithMany()
